...
const Navbar = () => {
  return (
    <nav className="bg-white shadow-sm z-10 flex flex-col text-center content-center sm:flex-row sm:text-left sm:justify-between py-2 px-6 sm:items-baseline w-full">
